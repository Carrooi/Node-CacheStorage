...
(function() {
 ...
 '/lib/Storage/Storage.js': function(exports, module) {
	...
	// Generated by CoffeeScript 1.6.3
	(function() {
	  var Cache, Storage, checkFilesSupport, isWindow, moment, path;
	...
	(function() {
	  ...
	  BrowserLocalStorage = (function(_super) {
	    ...
	    BrowserLocalStorage.prototype.async = false;
...
}, '/lib/Storage/DevNullSyncStorage.js': function(exports, module) {

	/** node globals **/
	var require = function(name) {return window.require(name, '/lib/Storage/DevNullSyncStorage.js');};
	require.resolve = function(name, parent) {if (parent === null) {parent = '/lib/Storage/DevNullSyncStorage.js';} return window.require.resolve(name, parent);};
	require.define = function(bundle) {window.require.define(bundle);};
	require.cache = window.require.cache;
	var __filename = '/lib/Storage/DevNullSyncStorage.js';
	var __dirname = '/lib/Storage';
	var process = {cwd: function() {return '/';}, argv: ['node', '/lib/Storage/DevNullSyncStorage.js'], env: {}};
	...
	(function() {
	  ...
	  FileStorage = (function(_super) {
	    ...
	    FileStorage.prototype.async = false;
	...
	(function() {
	  ...
	  MemoryStorage = (function(_super) {
	    ...
	    MemoryStorage.prototype.async = false;
...
}, '/test/browser/tests/DevNullSyncStorage.coffee': function(exports, module) {

	/** node globals **/
	var require = function(name) {return window.require(name, '/test/browser/tests/DevNullSyncStorage.coffee');};
	require.resolve = function(name, parent) {if (parent === null) {parent = '/test/browser/tests/DevNullSyncStorage.coffee';} return window.require.resolve(name, parent);};
	require.define = function(bundle) {window.require.define(bundle);};
	require.cache = window.require.cache;
	var __filename = '/test/browser/tests/DevNullSyncStorage.coffee';
	var __dirname = '/test/browser/tests';
	var process = {cwd: function() {return '/';}, argv: ['node', '/test/browser/tests/DevNullSyncStorage.coffee'], env: {}};

	/** code **/
	(function() {
	  var Cache, DevNullSyncStorage, cache;
	  ...
	  describe('DevNullSyncStorage', function() {
	    beforeEach(function() {
	      return cache = new Cache(new DevNullSyncStorage);
	    });
...
, 'cache-storage/Storage/DevNullSyncStorage': function(exports, module) { module.exports = window.require('/lib/Storage/DevNullSyncStorage'); }
...
require.__setStats({"/lib/Storage/Storage.js":{"atime":1389393897000,"mtime":1389393757000,"ctime":1389393757000},"moment/moment.js":{"atime":1389389798000,"mtime":1387832828000,"ctime":1389389769000},"/lib/Cache.js":{"atime":1389393897000,"mtime":1389393757000,"ctime":1389393757000},"fs-mock/lib/fs.js":{"atime":1389391434000,"mtime":1389273046000,"ctime":1389391420000},"fs-mock/lib/Stats.js":{"atime":1389391434000,"mtime":1389269301000,"ctime":1389391420000},"fs-mock/lib/Errors.js":{"atime":1389391434000,"mtime":1389269301000,"ctime":1389391420000},"fs-mock/lib/FSWatcher.js":{"atime":1389391434000,"mtime":1389269301000,"ctime":1389391420000},"escape-regexp/index.js":{"atime":1389391434000,"mtime":1345153109000,"ctime":1389391421000},"/lib/Storage/BrowserLocalStorage.js":{"atime":1389436096000,"mtime":1389435978000,"ctime":1389435978000},"/lib/Storage/DevNullSyncStorage.js":{"atime":1389436287000,"mtime":1389436184000,"ctime":1389436184000},"/lib/Storage/FileStorage.js":{"atime":1389436096000,"mtime":1389435994000,"ctime":1389435994000},"/lib/Storage/MemoryStorage.js":{"atime":1389436096000,"mtime":1389436002000,"ctime":1389436002000},"/test/browser/tests/BrowserLocalStorage.coffee":{"atime":1389390423000,"mtime":1384025482000,"ctime":1384025482000},"/test/browser/tests/Cache.coffee":{"atime":1389390423000,"mtime":1383999743000,"ctime":1383999970000},"/test/browser/tests/DevNullSyncStorage.coffee":{"atime":1389436506000,"mtime":1389436418000,"ctime":1389436505000},"/test/browser/tests/FileStorage.coffee":{"atime":1389390423000,"mtime":1383999743000,"ctime":1383999977000},"/test/browser/tests/MemoryStorage.coffee":{"atime":1389390423000,"mtime":1383999743000,"ctime":1383999980000},"/package.json":{"atime":1389393757000,"mtime":1389393756000,"ctime":1389393756000},"moment/package.json":{"atime":1389389792000,"mtime":1389389769000,"ctime":1389389769000}});
...
/** /test/browser/tests/DevNullSyncStorage **/
require('/test/browser/tests/DevNullSyncStorage');
